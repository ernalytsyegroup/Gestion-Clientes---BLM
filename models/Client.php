...
class Client {
    ...
    public function create() {
        ...
        // Consulta básica sin id_plan ni id_empresa
        $query = "INSERT INTO " . $this->table_name . " 
                  (nombre_cliente, fecha_inicio, cumpleaños, fecha_pago) 
                  VALUES (?, ?, ?, ?)";
    ...
    // Read all clients (filtered by user access if not admin)
    ...
    // Update client - Versión simplificada para evitar errores
    public function update() {
        ...
        $stmt->bindParam(3, $this->cumpleaños);
        $stmt->bindParam(4, $this->fecha_pago);
        $stmt->bindParam(5, $id_plan);
        $stmt->bindParam(6, $id_empresa);
        $stmt->bindParam(7, $this->id_cliente);
